...
namespace api.Migrations
{
    ...
    [Migration("20240531162342_addForeignKeyBetweenGradeAndGradeModel")]
    partial class addForeignKeyBetweenGradeAndGradeModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Entities.GradeEntity", b =>
                {
                    b.HasOne("api.Models.GradeModelEntity", "GradeModelEntity")
                        .WithMany("GradeList")
                        .HasForeignKey("GradeModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GradeModelEntity");
                });
